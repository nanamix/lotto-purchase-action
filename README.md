...
기본 설정은 **매주 일요일 12:00 KST에 GitHub Models 추천 번호 5게임을 구매**합니다. GitHub Actions 화면에서 즉시 수동 실행도 할 수 있고, 실행할 때 구매 방식과 게임 수를 고를 수 있습니다.
...
기본 AI 추천은 GitHub Models API를 사용합니다.
