...
- 스케줄 실행 기본값: `ai-recommendation` + `AI_PROVIDER=copilot` + `game-count=5`
...
`05-ai-recommendation.js`는 `AI_PROVIDER`로 GitHub Models 또는 Gemini를 선택하고, `AI_GAME_COUNT`로 1~5게임을 구매합니다. `github`, `github-models`, `copilot`은 모두 GitHub Models 호출로 처리됩니다.
